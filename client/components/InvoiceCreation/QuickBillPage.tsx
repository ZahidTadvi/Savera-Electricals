    ...
    try {
      ...
      for (let i = 0; i < customerBills.length; i++) {
        ...
        try {
          ...
          // Calculate GST amount using dynamic percentage on total subtotal
          let gstAmount = completeBill.gstAmount || 0;
          // Always recalculate GST with dynamic percentage
          ...
          // Apply state-wise GST logic with dynamic percentage
          ...
          const invoiceData = {
            ...
            items: (completeBill.items || []).map((item: any) => {
              ...
              const gstPercent = gstPercentage; // Use dynamic GST percentage
